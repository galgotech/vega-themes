(function (global, factory) {
   ...
   * https://developers.google.com/open-source/licenses/bsd
   */
  var markColor$8 = '#3366CC';
  var gridColor$2 = '#ccc';
  var fontColor = '#52545c';
  var fontSize = 12;
  var defaultFont$1 = 'Montserrat, Helvetica Neue, Arial, sans-serif';
  var googlechartsTheme$1 = {
      arc: { fill: markColor$8 },
      area: { fill: markColor$8 },
      path: { stroke: markColor$8 },
      rect: { fill: markColor$8 },
      shape: { stroke: markColor$8 },
      symbol: { stroke: markColor$8 },
      circle: { fill: markColor$8 },
      background: '#fff',
      padding: {
          top: 10,
          right: 10,
      ...
      axis: {
          gridColor: gridColor$2,
          tickColor: gridColor$2,
          labelFont: defaultFont$1,
          labelColor: fontColor,
          labelFontSize: fontSize,
          titleFont: defaultFont$1,
  ...
  exports.grafana = googlechartsTheme$1;
